						...
						case 'navigation': ?>
							...
							<div id="WIP_plugin_panel_tabs">
								...
								<ul>
                                    ...
                                    <li><a target="_blank" href="<?php echo esc_url('https://woocarousel.demo.themeinprogress.com/free-version/');?>"><?php esc_html_e( 'Documentation', 'wip-woocarousel-lite'); ?></a></li>
